...
export function AuthScreen() {
  ...
  return (
    <div
      className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 font-sans relative bg-cover bg-center bg-no-repeat overflow-hidden"
